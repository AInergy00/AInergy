      ...
      messages: [
        {
          ...
          content: `
            ...
            2. 항상 예의 바른 첫인사로 시작하고, 받는 사람을 언급하세요.
            3. 쪽지의 목적을 간략하게 소개하는 문장을 포함하세요.
            4. 주요 정보(일시, 장소, 참석자, 안건, 준비물 등)는 구조화하되 마크다운 형식(-, **, 등)을 사용하지 마세요.
            5. 값이 없거나 '미정', '없음'인 항목은 표시하지 마세요.
            6. 필요한 경우 추가 안내사항이나 당부사항을 포함하세요.
            7. 정중하고 공식적인 끝인사로 마무리하되, '[당신의 이름] 드림'은 포함하지 마세요.
